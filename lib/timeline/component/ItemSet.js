 ...
 * @private
 */
ItemSet.prototype.getGroupId = function (itemData) {
 ...
 * @private
 */
ItemSet.prototype._addItem = function(item, batch = false) {
...
ItemSet.prototype.getClusters = function () {
  return Object.values(this.items).filter(item => item.isCluster);
}
...
// ItemSet.prototype._redrawGroups = function(groups) {
...
//   for (let groupToUpdate of groups) {
//     var groupMargin = groupToUpdate == firstGroup ? firstMargin : nonFirstMargin;
//     const redrawQueue = groupToUpdate.redraw(range, groupMargin, false, true);
//     while(redrawQueue.length) {
//       const fn = redrawQueue.shift();
//       fn();
//     }
//   }
// }
